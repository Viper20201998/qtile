# Generated by Powerlevel10k configuration wizard on 2021-10-04 at 15:39 CST.
...
prompt_zsh_internet_signal(){
  local color
  local symbol="\uf7ba"
  local strength=`iwconfig wlp0s20f3 | grep -i "link quality" | grep -o "[0-9]*/[0-9]*"`
  
  echo -n "$symbol $strength"
}
...
() {
  ...
  typeset -g POWERLEVEL9K_CUSTOM_WIFI="prompt_zsh_internet_signal"
  typeset -g POWERLEVEL9K_CUSTOM_WIFI_BACKGROUND=0
  typeset -g POWERLEVEL9K_CUSTOM_WIFI_FOREGROUND=4
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{blue}╰─ﮊ '
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=241
